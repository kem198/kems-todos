...
public class Examples2DaoTest {
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/net/kem198/todos_api/infrastructure/dao/Examples2Dao/selectById.sql", dialect);
        execute(sqlFile);
    }
